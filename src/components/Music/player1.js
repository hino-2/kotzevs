var Framer = {
  ...
  drawTick: function (x1, y1, x2, y2) {
      ...
      gradient.addColorStop(0, '#e9790b');                  // цвет тиков
      gradient.addColorStop(0.6, '#cc7927');
  ...
  drawEdging: function () {
      this.context.save();
      this.context.beginPath();
      this.context.strokeStyle = '#e9790b';
      this.context.lineWidth = 1;
...
var Tracker = {
  ...
  drawArc: function () {
      this.context.save();
      this.context.strokeStyle = '#1e7e34';
      this.context.beginPath();
...
var Scene = {
  ...
  calculateSize: function () {
      this.scaleCoef = Math.max(0.5, 640 / this.optimiseHeight);
...
var Player = {
  ...
  loadTrack: function (song) {
      ...
      var track = song;
      document.querySelector('#songName').textContent = track.song;
      this.currentSongIndex = track.id;
